...
// plan ($399/mo + $5 overage). Returns `{ url }` for the client to redirect.
//
...
// $399/mo with $5/overage is encoded as the up-front session amount; recurring
...
const PLAN_PRICES: Record<string, { amount_cents: number; label: string }> = {
  pro: { amount_cents: 39900, label: "LeaseBrief Pro — 50 abstracts/mo" },
};
